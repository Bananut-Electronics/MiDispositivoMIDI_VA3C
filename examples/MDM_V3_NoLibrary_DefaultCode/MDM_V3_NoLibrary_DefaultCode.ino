 ...
 *                                                                  *
 * Code:     MDM_V3_NoLibrary_DefaultCode.ino                       *
 * Hardware: One MiDispositivoMIDI V3 (4x4) .                       *
 * Brief:    This code is loaded by default if you have bought our  *
 *           V3 device. Note that it does not use the C++ Arduino   *
 *           library, that was released after this code. This code  *
 *           is left as legacy and might be useful for people that  *
 *           want to know more in depth details of how the device   *
 *           work. Feel free to update your code to a new one that  *
